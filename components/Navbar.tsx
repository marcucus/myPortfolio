...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div
        className={`mx-auto rounded-full transition-all duration-700 ease-out relative border border-white/25 shadow-[0_8px_32px_0_rgba(0,0,0,0.4),inset_0_1px_0_0_rgba(255,255,255,0.15),0_1px_2px_0_rgba(0,0,0,0.3)] backdrop-blur-[30px] backdrop-saturate-[180%] bg-gradient-to-br from-white/15 to-white/8 ${
