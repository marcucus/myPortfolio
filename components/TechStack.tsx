...
interface Tech {
  ...
  // Mapping des dégradés CSS pour chaque technologie
  const colorGradients: Record<string, string> = {
    'from-cyan-400 to-blue-500': 'linear-gradient(135deg, #22d3ee, #3b82f6)',
    'from-blue-400 to-purple-500': 'linear-gradient(135deg, #60a5fa, #a78bfa)',
    ...
    'from-yellow-400 to-yellow-500': 'linear-gradient(135deg, #facc15, #eab308)',
    ...
    'from-orange-500 to-yellow-600': 'linear-gradient(135deg, #f97316, #ca8a04)',
    'from-cyan-400 to-teal-500': 'linear-gradient(135deg, #22d3ee, #14b8a6)',
  };
...
export default function TechStack() {
  ...
  const technologies: Tech[] = [
    ...
    { name: 'React Native', icon: FaMobile, level: 70, category: 'Mobile', color: 'from-blue-400 to-purple-500' },
    { name: 'TypeScript', icon: SiTypescript, level: 95, category: 'Language', color: 'from-blue-500 to-blue-600' },
    { name: 'Next.js', icon: SiNextdotjs, level: 90, category: 'Frontend', color: 'from-gray-400 to-gray-600' },
    { name: 'JavaScript', icon: SiJavascript, level: 95, category: 'Language', color: 'from-yellow-400 to-yellow-500' },
    { name: 'Node.js', icon: FaNode, level: 75, category: 'Backend', color: 'from-green-400 to-green-600' },
    { name: 'NestJS', icon: SiNestjs, level: 90, category: 'Backend', color: 'from-red-500 to-pink-500' },
    ...
    { name: 'SQL', icon: FaDatabase, level: 90, category: 'Database', color: 'from-orange-400 to-red-500' },
    { name: 'AWS', icon: FaAws, level: 10, category: 'Cloud', color: 'from-orange-500 to-yellow-600' },
  ...
  return (
    <section id="stack" className="min-h-screen py-20 px-4 relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <h2 className="text-4xl md:text-5xl font-bold mb-4 text-center bg-linear-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
          Stack Technique
        </h2>
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: colorGradients[tech.color] || '#222',
                  }}
                />
                ...
                <div className="relative z-10">
                  ...
                  <div className="relative h-2 bg-white/10 rounded-full overflow-hidden">
                    <div
                      className={`h-full bg-linear-to-r ${tech.color} transition-all duration-1000 ease-out rounded-full`}
                      style={{
                  ...
                  <div className="text-center mt-2">
                    <span className={`text-sm font-bold bg-linear-to-r ${tech.color} bg-clip-text text-transparent`}>
                      {tech.level}%
                    </span>
                  </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          ...
          <div className="glass-effect-strong rounded-2xl p-6 text-center">
            <div className="text-4xl font-bold bg-linear-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent mb-2">
              10+
            </div>
